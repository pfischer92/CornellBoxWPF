...
namespace CornellBoxWPF
{
    public class Scene
    {
        ...
        {            
            ...
            Vector3 m = hitpoint.Sphere.Color;                                      // Color of Hitpoint
            ...
            if (checkBoxControl.IsDiffuseCheckBoxChecked)
            {
                 ...
                 if (nL >= 0)
                 {      
                     diffLight = lightIntensity * hitpoint.Sphere.Color * nL;
                 }
                 color = diffLight;
            }
            ...
            if (checkBoxControl.IsSpecularCheckBoxChecked)
            {
                if (nL >= 0)
                {
                    ...
                    Vector3 phong = lightIntensity * phongFactor;
                    color = color + phong;
                }
            }
            ...
            if (checkBoxControl.IsShadowCheckBoxChecked)
            {
                ...
                if (shadow != null && (shadow.H - hitpoint.H).Length() < (lightPos - hitpoint.H).Length())
                {
                    color -= lightIntensity * color * 0.5f;
                }
            }
